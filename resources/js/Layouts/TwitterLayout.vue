        ...
        <div class="max-w-[1400px] flex mx-auto">
            ...
            <div class="lg:block hidden lg:w-4/12 h-screen border-l border-gray-800 pl-4">
                <div class="w-full p-1 mt-2 px-4 lg:flex items-center rounded-full hidden bg-[#212327]">
                    <Magnify fillColor="#5e5c5e" :size="25" />
                    <input
                        class="
                            appearance-none
                            w-full
                    ...
                    <div class="h-[80px] hover:bg-gray-800 cursor-pointer transition duration-200 ease-in-out">
                        <div class="flex p-3 justify-between h-[80px] py-3">
                            <div>
                                ...
                                <div class="text-full text-white font-extrabold mb-6 text-[17px]">Australian Open 2023</div>
                            </div>
                            <img :src="randImg2" alt="" class="rounded">
                        </div>
                    </div>
                    ...
                    <div class="hover:bg-gray-800 cursor-pointer transition duration-200 ease-in-out">
                        <div class="flex p-3 justify-between">
                            <div>
                                ...
                                <div class="text-full text-white font-extrabold text-[17px]">Doomsday Clock</div>
                    ...
                    <div class="hover:bg-gray-800 cursor-pointer transition duration-200 ease-in-out">
                        <div class="flex p-3 justify-between">
                            <div>
                                ...
                                <div class="text-full text-white font-extrabold text-[17px]">Sunak</div>
                    ...
                    <div class="hover:bg-gray-800 cursor-pointer transition duration-200 ease-in-out">
                        <div class="flex p-3 justify-between">
                            <div>
                                ...
                                <div class="text-full text-white font-extrabold text-[17px]">Poro</div>
        ...
        <div class="md:max-w-2xl md:mx-auto md:mt-10 md:rounded-xl bg-black">
            ...
            <div class="w-full flex">
                <div class="ml-3.5 mr-2">
                    <img :src="randImg1" width="55" alt="" class="rounded-full">
                </div>
                <div class="w-[calc(100%-100px)]">
                    ...
                    <div class="w-full">
                        ...
                        <img v-else :src="showUpload" alt="">
                    </div>
                    <div class="flex py-2 items-center text-[#1C9CEE] font-extrabold">
